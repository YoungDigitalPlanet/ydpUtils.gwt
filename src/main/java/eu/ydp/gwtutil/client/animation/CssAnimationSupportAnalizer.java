...
public class CssAnimationSupportAnalizer {
    ...
    private boolean hasSupportCurrentMobileBrowser() {
        return userAgentUtil.isMobileUserAgent(MobileUserAgent.CHROME, MobileUserAgent.SAFARI, MobileUserAgent.FIREFOX, MobileUserAgent.ANDROID4);
    }

    private boolean hasSupportCurrentDesktopBrowser() {
        return userAgentUtil.isUserAgent(UserAgent.GECKO1_8, UserAgent.SAFARI);
    }
}
