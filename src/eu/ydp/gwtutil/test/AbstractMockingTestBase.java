	...
	private T instantiateModuleClass() {
		...
		try {
			...
			throw new IllegalArgumentException(
					"Problem while creating instance of Guice module. Arguments mismatch. An array or arrays of Class objects was expected.", e);
		} catch (Exception e) {
			throw new RuntimeException("Problem while creating instance of Guice module. Make sure that there is no-arg constructor available in the module.",
					e);
		}
		return inst;
	}
