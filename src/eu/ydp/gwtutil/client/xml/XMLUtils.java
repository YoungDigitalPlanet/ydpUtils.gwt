...
public final class XMLUtils {
	 ...
	 *            Attribute name
	 * @param defaultValue
	 *            wartosc domyslna zwracana jezeli atrybut nie istnieje
	 * @return attribute text or empty string if not found
	 */
	 ...
	 *            Element to map
	 * @param ignore
	 *            array of attributes that should be ignored (not added to the map if they appear)
