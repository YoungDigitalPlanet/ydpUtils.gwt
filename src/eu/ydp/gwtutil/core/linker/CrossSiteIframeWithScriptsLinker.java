package eu.ydp.gwtutil.core.linker;
...
public class CrossSiteIframeWithScriptsLinker extends CrossSiteIframeLinker {
	...
	private static String generateScriptInjector(String scriptUrl) {
		if (isRelativeURL(scriptUrl)) {
			return "  if (!__gwt_scriptsLoaded['" + scriptUrl + "']) {\n" + "    __gwt_scriptsLoaded['" + scriptUrl + "'] = true;\n"
					+ "    document.write('<script language=\\\"javascript\\\" src=\\\"'+computeScriptBase()+'" + scriptUrl + "\\\"></script>');\n" + "  }\n";
		} else {
			return "  if (!__gwt_scriptsLoaded['" + scriptUrl + "']) {\n" + "    __gwt_scriptsLoaded['" + scriptUrl + "'] = true;\n"
	...
	protected String getSelectionScriptTemplate(TreeLogger logger, LinkerContext context) {
		return "eu/ydp/gwtutil/core/linker/CrossSiteIframeWithScriptsTemplate.js";
	}
}