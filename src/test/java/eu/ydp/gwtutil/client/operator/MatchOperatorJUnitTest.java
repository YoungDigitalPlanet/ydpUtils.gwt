...
public class MatchOperatorJUnitTest {
	...
	private MatchOperator equalOperator = MatchOperator.getOperator(MatchOperator.EQUAL.getName());
	private MatchOperator notEqualOperator = MatchOperator.getOperator(MatchOperator.NOT_EQUAL.getName());
	private MatchOperator greaterOperator = MatchOperator.getOperator(MatchOperator.GREATER.getName());
	private MatchOperator greaterEqualOperator = MatchOperator.getOperator(MatchOperator.GREATER_EQUAL.getName());
	private MatchOperator lessOperator = MatchOperator.getOperator(MatchOperator.LESS.getName());
	private MatchOperator lessEqualOperator = MatchOperator.getOperator(MatchOperator.LESS_EQUAL.getName());
	private MatchOperator noneOperator = MatchOperator.getOperator(MatchOperator.NONE.getName());
